    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b> Dardpora Kralpora Kupwara, J&K</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at + (91) 8491980553</a></p> </div>
          ...
          <Link to={'https://github.com/nayeem7866'} className='gap-3' id='footer-link'>
          <BsGithub />
          </Link>
          </div>
        </div>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by Nayeem 2024</p>
        </div>
        <div className="col-12 col-md-6">
